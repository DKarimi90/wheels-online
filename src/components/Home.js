    ...
    <div className="w-full mb-24">
        ...
        <div className="w-100 mx-auto px-6 sm:max-w-2xl md:max-w-3xl md:px-12 lg:max-w-5xl xl:max-w-7xl xl:px-32">
          <div className="text-center">
            <div className="block rounded-lg bg-[hsla(0,0%,100%,0.8)] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-[hsla(0,0%,15%,0.8)] dark:shadow-black/20 md:py-16 md:px-12" style={{marginTop: '180px', backdropFilter: 'saturate(200%) blur(25px)'}}>
              <h1 className="mt-6 mb-16 text-5xl font-bold tracking-tight md:text-6xl xl:text-7xl text-gray-700">
              Proudly Serving for 20 Years with <br /><span className="text-gray-700">Precision and Excellence</span>
              </h1>
              <Link to="shop" className="mb-2 inline-block rounded bg-primary px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-black shadow-[0_4px_9px_-4px_#3b71ca] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.3),0_4px_18px_0_rgba(59,113,202,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(59,113,202,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(59,113,202,0.2),0_4px_18px_0_rgba(59,113,202,0.1)] md:mr-2 md:mb-0" data-te-ripple-init data-te-ripple-color="light" href="#!" role="button">Get started</Link>
              <button><Link to="oops" className=" button inline-block rounded px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-primary transition duration-150 ease-in-out hover:bg-neutral-500 hover:bg-opacity-10 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 dark:hover:bg-neutral-700 dark:hover:bg-opacity-40" data-te-ripple-init data-te-ripple-color="light" href="#!" role="button">Discover</Link></button>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='w-full h-full max-w-[1200px] mx-auto grid grid-rows-none md:grid-cols-5 gap-5 px-2 mb-24'>
        <div className='w-full h-full object-cover hover:scale-105 duration-500 col-span-2 md:col-span-3 row-span-2 relative'>
            <img src="./images/sport.jpg" alt="Range"/>
            <span className='absolute top-0 right-4 text-4xl lg:text-6xl font-bold text-gray-400'>13% Off</span>
            <span className='absolute text-center top-10 lg:top-16 right-4 text-md lg:text-2xl max-w-[20%] italic font-[regular] text-[var(--primary2)]'>Visit the site for more</span>
        </div>
          <div className='relative'>
            <img src="./images/BMW2.jpg" alt="volvo" className='hero-images'/>
            <span className='hero-span'>BMW X5</span>
          </div>
          <div className='relative'>
            <img src="./images/prado.jpeg" alt="prado" className='hero-images'/>
            <span className='hero-span'>PRADO</span>
          </div>
          <div className='relative'>
            <img src="./images/volvo1.png" alt="volvo" className='hero-images'/>
            <span className='hero-span text-white'>VOLVO</span>
          </div>
          <div className='relative'>
            <img src="./images/jeep.png" alt="jeep" className='hero-images'/>
            <span className='hero-span'>JEEP</span>
          </div>
        </div>
      </div>
    </div>
